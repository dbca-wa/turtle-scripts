...
```{r map_emb_animated, warning=FALSE}
...
tracks_emb %>% tracks_ts(placename_emb, prefix_emb)
...
tracks_emb_ap %>% tracks_ts(placename_emb_ap, prefix_emb)
...
tracks_emb_cv %>% tracks_ts(placename_emb_cv, prefix_emb)
