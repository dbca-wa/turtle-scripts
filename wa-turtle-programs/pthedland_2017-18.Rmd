...
tracks_pth <- tracks_2017 %>% filter_port_hedland_sites() %>% filter_realspecies()
tracks_pth_cem <- tracks_2017 %>% filter_port_hedland_cemetery() %>% filter_realspecies()
tracks_pth_ppo <- tracks_2017 %>% filter_port_hedland_prettypool() %>% filter_realspecies()
