...
surveys_bb %>% plot_survey_count("West Pilbara Bells Beach", prefix)
surveys_bb %>% list_survey_count("West Pilbara Bells Beach")

surveys_yc %>% plot_survey_count("West Pilbara Yacht Club Beach", prefix)
...
surveys_bb %>% plot_survey_effort("West Pilbara Bells Beach", prefix)
surveys_bb %>% list_survey_effort("West Pilbara Bells Beach")

surveys_yc %>% plot_survey_effort("West Pilbara Yacht Club Beach", prefix)
