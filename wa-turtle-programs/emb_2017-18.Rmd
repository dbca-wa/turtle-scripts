...
```{r load_data}
tracks_2017 <- tracks_all %>% filter_2017() %>% filter_realspecies() %>% add_nest_labels()
tracks_emb <- tracks_2017 %>% filter_emb()
tracks_emb_ap <- tracks_2017 %>% filter_emb_ap()
tracks_emb_cv <- tracks_2017 %>% filter_emb_cvp()
...
nests_emb <- nests_all %>% filter_2017() %>% filter_emb()
