...
At Anna Plains, assuming the round trip was 2 km,
`r nrow(filter(surveys, site_id==36)) * 2` km were walked 
in `r nrow(filter(surveys, site_id==36))` surveys.

At Yacht Club Beach, assuming the round trip was 2 km,
`r nrow(filter(surveys, site_id==36)) * 2` km were walked 
in `r nrow(filter(surveys, site_id==36))` surveys.
