...
cbb <-  tracks_2017 %>% filter_broome()
cbb1 <- tracks_2017 %>% filter_cbb1()
cbb2 <- tracks_2017 %>% filter_cbb2()
cbb3 <- tracks_2017 %>% filter_cbb3()
...
Note on 2018-01-16 23:07:07.644000+00:00 by Jessamy Ham: no survey due to heavy rains.
This leads to a skipped survey on the morning of calendar date 2018-01-17.
[See record in WAStD](https://tsc.dbca.wa.gov.au/admin/observations/encounter/11812/change/).
