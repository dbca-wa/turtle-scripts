...
download_and_save_data <- function(){
  ...
  # SV start
  ruODK::ru_setup(pid=1, fid=fl$fid[[5]], url=prod)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  svs_prod <- ruODK::odata_submission_get(table = ft$url[[1]], verbose = T)
  
  # SV end
  ruODK::ru_setup(pid=1, fid=fl$fid[[4]], url=prod)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  sve_prod <- ruODK::odata_submission_get(table = ft$url[[1]], verbose = T)
  
  # MWI
  ruODK::ru_setup(pid=1, fid=fl$fid[[2]], url=prod)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  mwi_prod <- ft$url[[1]] %>% 
  ...
  # Dist
  ruODK::ru_setup(pid=1, fid=fl$fid[[3]], url=prod)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  dist_prod <- ruODK::odata_submission_get(table = ft$url[[1]], verbose = T)
  
  # Tracks
  ruODK::ru_setup(pid=1, fid=fl$fid[[8]], url=prod)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  ...
  # SV start
  ruODK::ru_setup(pid=1, fid=fl$fid[[5]], url=uat)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  ...
  # SV end
  ruODK::ru_setup(pid=1, fid=fl$fid[[4]], url=uat)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  ...
  # MWI
  ruODK::ru_setup(pid=1, fid=fl$fid[[2]], url=uat)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  mwi_uat <- ft$url[[1]] %>% 
  ...
  # Dist
  ruODK::ru_setup(pid=1, fid=fl$fid[[3]], url=uat)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  ...
  # Tracks
  ruODK::ru_setup(pid=1, fid=fl$fid[[8]], url=uat)
  message(glue::glue("Downloading {ruODK::get_default_fid()}"))
  ft <- ruODK::odata_service_get()
  ft %>% knitr::kable(.)
  tracks_uat <- ft$url[1] %>% 
