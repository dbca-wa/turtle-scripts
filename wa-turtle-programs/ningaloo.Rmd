...
* Survey dates. Please correct the survey dates to the date the surveys were actually done. For some reason they have been adjusted to the day before. This is wasting our time correcting. We need the actual dates to compare among years and importantly for operational reasons on the ground at Ningaloo. Not at all helpful to have them changed to the day before.
* Predation versus predator tracks. We need to be able to access records of predation where there is actually evidence of a nest being preyed upon, versus just tracks of predators being recorded where there was no evidence of predation occurring. At this stage, the two seem to have been lumped together. We need to be able to extract each separately.
* Survey effort. We need to be able to access the individual and the total number of days each subsection was monitored. This doesn’t appear possible at present.
* Reliable records of which subsections were monitored and when. At present the data provided indicate that some subsections were monitored twice on some days and adjacent subsections weren’t monitored at all. We know this to be incorrect. It needs to be fixed.
