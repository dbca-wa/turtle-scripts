...
## Survey effort
TODO linear  “calendar” with one box per day and colour one colour for tagging, one colour for morning surveys, one colour for marking nests and excavating . that will show start and end date of nesting season + number of days for each year +missed days
...
```{r map_del_2018}
tracks_del %>% filter_2018() %>% map_tracks()
```
...
googledrive::drive_upload("delambre.html", path=glue::glue("Delambre/delambre.html"))
