...
```{r survey_count}
surveys_thv %>% plot_survey_count(placename_thv, prefix_thv)
...
```{r survey_effort}
surveys_thv %>% plot_survey_effort(placename_thv, prefix_thv)
surveys_thv %>% list_survey_effort(placename_thv)

surveys_di %>% plot_survey_effort(placename_di, prefix_di)
surveys_di %>% list_survey_effort(placename_di)

surveys_ri %>% plot_survey_effort(placename_ri, prefix_ri)
