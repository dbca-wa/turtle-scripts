...
TODO: add beaches at Lalang Garram NP. Fix outlier tracks at Thv.
...
# QA
This section identified tracks outside known sites and missing surveys.
We show data from all regions.
...
tracks_all %>%
  ...
  dplyr::tally() %>%
  dplyr::mutate(number_of_tracks = n) %>%
