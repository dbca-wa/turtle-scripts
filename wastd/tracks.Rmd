...
success_summary <- nests %>%
  ...
  dplyr::summarize(
    "count" = n(),
    "clutch_size_mean" = mean(clutch_size),
    "clutch_size_sd" = sd(clutch_size),
    "clutch_size_min" = min(clutch_size),
    "clutch_size_max" = max(clutch_size),
    "hatching_success_mean" = mean(hatching_success),
    "hatching_success_sd" = sd(hatching_success),
    "hatching_success_min" = min(hatching_success),
    "hatching_success_max" = max(hatching_success),
    "emergence_success_mean" = mean(emergence_success),
    "emergence_success_sd" = sd(emergence_success),
...
d.spdf.grd <- d.spdf %>%
  spCbind(over(d.spdf, grd)) %>% spCbind(over(d.spdf, tagging_area))
...
TODO: above as one figure per species
TODO: fit GAM
...
* 36 days surveyed
* Flatbacks: 35.8  31.8 tracks.day-1 (range 1- 119) – Green : 26.7  15.8 tracks.day-1 (1-65) – Hawksbill : 1.8  1.7 tracks.day-1 (1-6)
* Nesting success: nb of successful tracks/total nb of tracks (excluding tagging data)
