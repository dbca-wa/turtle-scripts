...
datatable(tags_by_date, 
          caption = "Number of turtles handled per day")
```


```{r}
datatable(animals_by_date, 
          caption = "Number of individual turtles handled per day")
```
...
## Nesting success by species (tracks and tagging)
...
```{r lot_xt_pcnm}
# a little pedestrian but hey, it works
