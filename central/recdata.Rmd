...
ruODK::ru_setup(
  svc="https://odkcentral.dbca.wa.gov.au/v1/projects/2/forms/build_RecData-0-1_1570427499.svc"
)
tz <- "Australia/Perth"
...
leaflet::leaflet(width = 800, height = 600) %>%
  ...
  leaflet::addAwesomeMarkers(
    ...
    # 
    label = ~ glue::glue("[{asset_type}] {asset_label}"),
    popup = ~ glue::glue(
      "<h3>Asset</h3>",
      "Seen on {observation_start_time}</br>",
      "Seen by {reporter}</br>",
      "Device {device_id}</br>",
      '<div><img src="{asset_photo}"',
      ' height="150px" alt="asset photo"></img></div>',
      "Maintenance required: {maintenance_required}<br/>",
      "Visitor risk: {visitor_risk}",
...
r <- ckanr::resource_update("110ae1d3-691b-4530-b288-58cccf6c20ab", path = "recdata.html")
...
The report is uploaded to the corresponding dataset on the  
[DBCA data catalogue](https://data.dpaw.wa.gov.au/dataset/recdata-asset-management-data-capture).
This requires an account with write access on the data catalogue.
